...
document.querySelector("#open-proof")?.addEventListener("click", () => {
  dialog?.showModal();
});
...
document.querySelector("#demo-start")?.addEventListener("click", (event) => {
  const result = document.querySelector(".demo-result");
  if (result) result.style.display = "block";
  event.currentTarget.textContent = "Demo recording started";
