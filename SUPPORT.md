...
Questions about a private deployment's legal basis, provider contracts, cloud
account or reverse proxy remain the operator's responsibility.

Security vulnerabilities must follow [SECURITY.md](SECURITY.md). Public issues
are not a security-reporting channel.
